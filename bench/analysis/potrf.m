...
% l1 = plot_benchmark('data/dpotrf-blast-static-nounroll.json', factor);
% l1.DisplayName = 'no unroll';
% l1.LineWidth = line_width;
%
% l2 = plot_benchmark('data/dpotrf-blast-static-unroll.json', factor);
% l2.DisplayName = 'unroll';
% l2.LineWidth = line_width;

plot_rate('data/dpotrf-blast-static-unroll.json', 'data/dpotrf-blast-static-nounroll.json');

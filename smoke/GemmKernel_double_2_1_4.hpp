        ...
        double const * a, size_t sa, bool ta, double const * b, size_t sb, bool tb, double const * c, size_t sc, double * d, size_t sd)
    {
        ...
        else if (!ta && tb)
        {
            ...
            for (size_t k = 0; k < K; ++k, a += Traits::blockSize, b += Traits::blockSize)
            {
                ...
                // {
                //     __m256d const a0 = _mm256_load_pd(a + 4);
                //     __m256d const a4 = _mm256_load_pd(a + sa + 4);
                    
                //     __m256d bx = _mm256_broadcast_sd(b + 4);
                //     v00_ = _mm256_fmadd_pd(a0, bx, v00_);
                //     v40_ = _mm256_fmadd_pd(a4, bx, v40_);

                //     bx = _mm256_broadcast_sd(b + 5);
                //     v01_ = _mm256_fmadd_pd(a0, bx, v01_);
                //     v41_ = _mm256_fmadd_pd(a4, bx, v41_);

                //     bx = _mm256_broadcast_sd(b + 6);
                //     v02_ = _mm256_fmadd_pd(a0, bx, v02_);
                //     v42_ = _mm256_fmadd_pd(a4, bx, v42_);

                //     bx = _mm256_broadcast_sd(b + 7);
                //     v03_ = _mm256_fmadd_pd(a0, bx, v03_);
                //     v43_ = _mm256_fmadd_pd(a4, bx, v43_);
                // }
                
                // {
                //     __m256d const a0 = _mm256_load_pd(a + 8);
                //     __m256d const a4 = _mm256_load_pd(a + sa + 8);
                    
                //     __m256d bx = _mm256_broadcast_sd(b + 8);
                //     v00_ = _mm256_fmadd_pd(a0, bx, v00_);
                //     v40_ = _mm256_fmadd_pd(a4, bx, v40_);

                //     bx = _mm256_broadcast_sd(b + 9);
                //     v01_ = _mm256_fmadd_pd(a0, bx, v01_);
                //     v41_ = _mm256_fmadd_pd(a4, bx, v41_);

                //     bx = _mm256_broadcast_sd(b + 10);
                //     v02_ = _mm256_fmadd_pd(a0, bx, v02_);
                //     v42_ = _mm256_fmadd_pd(a4, bx, v42_);

                //     bx = _mm256_broadcast_sd(b + 11);
                //     v03_ = _mm256_fmadd_pd(a0, bx, v03_);
                //     v43_ = _mm256_fmadd_pd(a4, bx, v43_);
                // }
                
                // {
                //     __m256d const a0 = _mm256_load_pd(a + 12);
                //     __m256d const a4 = _mm256_load_pd(a + sa + 12);
                    
                //     __m256d bx = _mm256_broadcast_sd(b + 12);
                //     v00_ = _mm256_fmadd_pd(a0, bx, v00_);
                //     v40_ = _mm256_fmadd_pd(a4, bx, v40_);

                //     bx = _mm256_broadcast_sd(b + 13);
                //     v01_ = _mm256_fmadd_pd(a0, bx, v01_);
                //     v41_ = _mm256_fmadd_pd(a4, bx, v41_);

                //     bx = _mm256_broadcast_sd(b + 14);
                //     v02_ = _mm256_fmadd_pd(a0, bx, v02_);
                //     v42_ = _mm256_fmadd_pd(a4, bx, v42_);

                //     bx = _mm256_broadcast_sd(b + 15);
                //     v03_ = _mm256_fmadd_pd(a0, bx, v03_);
                //     v43_ = _mm256_fmadd_pd(a4, bx, v43_);
                // }
            }
